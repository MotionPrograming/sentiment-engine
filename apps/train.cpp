...
constexpr double NeutralWeightMultiplier = 4.00;
    ...
    const vector<Review>& rows)
{
    ...
    for (
         ...
         * IMPORTANT:
         *
         * Actual TF-IDF API is:
         *
         * transform_sparse(document)
         */
    ...
    try {
        ...
        for (
            ...
            for (
                 ...
                 *
                 * Class weighting is handled internally.
                 */
                svm.train_sample(
                    features,
                    review.sentiment,
